...
def getGitMetaData(vpn_provider):
    try:
        ...
        download_url = "https://raw.githubusercontent.com/eltonk/service.vpn.manager.providers/master/" + vpn_provider + "/METADATA.txt"
...
def refreshFromGit(vpn_provider, progress):
    ...
    for file in file_list:
        try:
            ...
            download_url = "https://raw.githubusercontent.com/eltonk/service.vpn.manager.providers/master/" + vpn_provider + "/" + file
            download_url = download_url.replace(" ", "%20")
            if ifHTTPTrace(): debugTrace("Using " + download_url)
